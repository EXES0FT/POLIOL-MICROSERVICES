...
export default defineEventHandler(async (event) => {
  ...
  try {
    ...
    SELECT
        ...
        CAST(rootAsm.[Parent Part Description] AS varchar(255)) AS component_part_description,
        CAST(rootAsm.[Parent Part Description] AS varchar(255)) AS root_part_description

    FROM [vAssemblies] rootAsm
    WHERE CAST(rootAsm.[Parent Part No] AS varchar(100)) = CAST(@productId AS varchar(100))
    ...
    SELECT
        ...
        CAST(pt.root_part_description AS varchar(255)) AS root_part_description
